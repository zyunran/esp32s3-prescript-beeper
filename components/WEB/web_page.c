...
"<div class=row><label>推荐配色</label><select id=gpreset onchange=gpreset(this.value)><option value=''>自定义</option></select></div>"
...
"Object.keys(G).forEach(k=>document.getElementById('gpreset').insertAdjacentHTML('beforeend','<option>'+k+'</option>'));"
