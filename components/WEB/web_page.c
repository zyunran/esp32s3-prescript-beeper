...
"<div class=row><label>息屏时钟自动乱码 <select id=aod_auto><option value=0>关</option><option value=30>30秒</option><option value=60>1分</option><option value=120>2分</option><option value=300>5分</option></select></label></div>"
...
"document.getElementById('cursor').value=j.cursor;document.getElementById('shake_swap').value=j.shake_swap;document.getElementById('aod_auto').value=j.aod_auto;"
...
"cursor:+document.getElementById('cursor').value,shake_swap:+document.getElementById('shake_swap').value,aod_auto:+document.getElementById('aod_auto').value,"
