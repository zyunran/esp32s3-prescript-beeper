...
"document.getElementById('cursor').value=j.cursor;document.getElementById('shake_swap').value=j.shake_swap;"
...
"cursor:+document.getElementById('cursor').value,shake_swap:+document.getElementById('shake_swap').value,"
