...
"<div class=row><label>真字 <input id=gdef type=text placeholder='#63A2EF' value='#63A2EF' style='width:100px' maxlength=7></label><label>乱码 <input id=ggb type=text placeholder='#3A5A8A' value='#3A5A8A' style='width:100px' maxlength=7></label></div>"
